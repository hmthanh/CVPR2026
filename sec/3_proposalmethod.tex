...
\begin{figure}[htp]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			enlargelimits=false,
			scatter/classes={
				green={mark=triangle*,draw=black,fill=green!50},
				orange={mark=triangle*,draw=black,fill=orange!60},
				blue={mark=triangle*,draw=black,fill=blue!60},
				yellow={mark=triangle*,draw=black,fill=yellow!80},
				purple={mark=triangle*,draw=black,fill=violet!70}
			},
			axis on top,
			clip=false
			]
...
\begin{figure}[htp]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			enlargelimits=false,
			scatter/classes={
				green={mark=diamond*,draw=black,fill=green!50},
				orange={mark=diamond*,draw=black,fill=orange!60},
				blue={mark=diamond*,draw=black,fill=blue!60}
			},
			axis on top,
			clip=false
			]
...
% 	\centering
% %	\resizebox{\linewidth}{!}{%
% %		\includegraphics{figures/transe.png}
% %	}
...
% 	% ------------------------------------------------------------------
% 	\tikzset{
% 		point/.style = {circle, fill=blue!70, inner sep=2pt},
% 		vblue/.style  = {thick, blue!70},
% 		vblack/.style = {thick, black},
% 		vred/.style   = {thick, red},
% 		vgreen/.style = {thick, green!60!black},
% 	}
...
% 	\caption{TransE embedding vector after linear transformation}
